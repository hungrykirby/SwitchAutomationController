...
from Commands import PythonCommandBase, Sender
...
class PokeControllerApp:
    ...
    def setCommandItems(self):
        classes_sorted = sorted(self.py_classes, key=lambda c:-1*c.SORT)
        self.py_cb['values'] = [c.NAME for c in classes_sorted]
